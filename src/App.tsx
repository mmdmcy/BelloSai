...
export const AVAILABLE_THEMES: Theme[] = [
  ...
  },
  {
    id: 'openai-dark',
    name: 'OpenAI Dark',
    description: 'A dark theme with green accents, inspired by modern AI interfaces.',
    primaryColor: '#10a37f',
    secondaryColor: '#10a37f',
    backgroundColor: '#202123',
    textColor: '#ffffff',
    accentColors: ['#10a37f', '#19c37d'],
    gradientEnabled: false,
...
const App: React.FC = () => {
  const { theme, setTheme, availableThemes, getTheme, applyTheme, isDark, hasGlassEffect } = useTheme();
