...
export default function Pricing() {
  ...
  const handleSelectPlan = async (priceId: string, planId: string) => {
    if (!user) {
      alert('Je moet eerst inloggen om een abonnement te kiezen.');
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          {hasActiveSubscription && (
            <div className="inline-flex items-center gap-2 bg-green-100 text-green-800 px-4 py-2 rounded-full">
              ...
              Je hebt al een actief Pro abonnement
            </div>
          )}
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="text-left">
              ...
              <p className="text-gray-600">
                Ja, je kunt je abonnement op elk moment opzeggen. Je behoud toegang tot Pro functies tot het einde van je betaalperiode.
              </p>
            </div>
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 mb-2">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 text-sm text-gray-600">
            ...
            Veilige betaling door Stripe • SSL versleuteld • Geen gegevens opgeslagen
          </div>
        </div>
      </div>
    </div>
